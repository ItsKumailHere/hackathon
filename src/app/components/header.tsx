    ...
    <header className="">
      ...
      <div className="bg-[#F5F5F5] flex justify-between items-center px-6 py-2 md:text-[11px] sm:text-[9px] text-[8px] font-medium text-gray-500">
        ...
        <div className="flex md:gap-4 sm:gap-3 gap-2">
          ...
          <Link href="/joing" className="hover:text-gray-800">
            Join Us
          </Link>
      ...
      <div className="flex flex-wrap justify-between items-center px-6 py-4">
        ...
        <nav className="flex  justify-center w-[70%] ml-3 gap-4 md:gap-6 text-gray-700 font-medium md:text-[16px] sm:text-[14px] text-[10px] ">
